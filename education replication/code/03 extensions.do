...
///	table 4: heterogeneity in treatment effect by sex, ses and baseline score
	...
	///	run regressions
		...
		xtreg m_theta_mle2 treat school treatschool m_theta_mle1, robust i(strata) fe
		outreg2 using "${output}table4.tex", tex(frag) label less(1) replace noaster 
			
		xtreg h_theta_mle2 treat school treatschool h_theta_mle1, robust i(strata) fe
